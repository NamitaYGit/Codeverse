...
const HeroSection = () => {
  ...
  return (
    <div className="relative bg-gradient-to-l from-blue-400 to-indigo-600 dark:from-gray-700 dark:to-gray-900 py-24 px-4 text-center ">
      <div className="max-w-3xl mx-auto ">
        ...
        <form onSubmit={searchHandler} className='flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-xl mx-auto mb-6'action="">
            <Input
            type="text"
            value={searchQuery}
